        ...
        return (
            <div>
                ...
                <div className="d-grid " >
                    <div className="row justify-content-around flex-wrap skill-container">
                        ...
                        <SkillBlock color="#40a139" icon={eduInProgressIcon} title="Начальный уровень" techs={["JavaScript","React", "Go"]}/>
                    </div>
