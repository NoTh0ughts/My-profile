    ...
    return (
      <div className="bg-black text-white d-inline-block">
        ...
        <div className="d-block p-4 ms-4">
            <h1  style={{color:"orange"}}>Привет, я Деревянкин Павел</h1>
            <h3 className="text-white text-opacity-75">C# Backend developer</h3>
            <br/>
            <h1 style={{color:"orange"}}>О себе:</h1>
            ...
            <img src={myPhoto} style={{ objectFit:"cover", width: '70%', height: undefined, aspectRatio: 1,}}  alt="logo"/>
        </div>
